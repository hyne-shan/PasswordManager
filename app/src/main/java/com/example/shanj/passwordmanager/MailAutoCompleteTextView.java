...
public class MailAutoCompleteTextView extends AutoCompleteTextView{
    ...
    private static final String[] emailSuffix = { "@qq.com", "@163.com", "@outlook.com", "@gmail.com", "@sina.com", "@hotmail.com",
            "@yahoo.cn", "@sohu.com", "@foxmail.com", "@139.com", "@yeah.net",  "@vip.qq.com", "@vip.sina.com" };

    public MailAutoCompleteTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
